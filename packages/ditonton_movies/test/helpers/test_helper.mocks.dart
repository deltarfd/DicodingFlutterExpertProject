...
// in ditonton_movies/test/helpers/test_helper.dart.
...
import 'package:ditonton_core/core/db/database_helper.dart' as _i15;
import 'package:ditonton_core/core/errors/failure.dart' as _i7;
...
class MockDatabaseHelper extends _i1.Mock implements _i15.DatabaseHelper {
  ...
  @override
  _i6.Future<int> insertWatchlist(Map<String, dynamic>? movieMap) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertWatchlist,
          [movieMap],
  ...
  @override
  _i6.Future<int> insertWatchlistTv(Map<String, dynamic>? tvMap) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertWatchlistTv,
          [tvMap],
