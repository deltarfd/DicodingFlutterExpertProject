...
void main() {
  ...
  group('TV main flow', () {
    testWidgets(
      ...
      print('DEBUG: 3) Open first TV item from Airing Today');
      final listCards = find.byType(InkWell);
      // Ensure we have items
      if (listCards.evaluate().isEmpty) {
        print('DEBUG: No items found in Airing Today. Checking for error...');
      ...
      print('DEBUG: 4) Toggle watchlist on Detail Page');
      ...
      // --- 2. Popular Flow ---
      print('DEBUG: 7) Tap "See More" (Popular)');
      ...
      print('DEBUG: 18) Check search results');
      ...
      if (resultItem.evaluate().isNotEmpty) {
        print('DEBUG: Search results found');
        ...
        if (find.byType(TvDetailPage).evaluate().isEmpty) {
          ...
          if (find.byType(TvSearchPage).evaluate().isNotEmpty) {
            print('DEBUG: Still on TvSearchPage');
          }
          fail('Did not navigate to TvDetailPage');
        }
        expect(find.widgetWithText(FilledButton, 'Watchlist'), findsOneWidget);

        print('DEBUG: Successfully navigated to detail page from search');
      } else {
        print('DEBUG: No search results found for "naruto"');
